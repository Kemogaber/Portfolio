      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredSkills.map((skill, key) => (
            <div
              key={key}
              className="bg-card p-6 rounded-xl shadow-lg card-hover border border-border/50 hover:border-primary/50 transition-all duration-300"
            >
              ...
              <div className="relative">
                <div className="w-full bg-secondary/30 h-3 rounded-full overflow-hidden">
                  <div
                    className="h-3 rounded-full bg-gradient-to-r from-primary to-primary/80 origin-left animate-grow relative overflow-hidden"
                    style={{ 
                      width: skill.level + "%",
